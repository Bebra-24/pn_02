...
namespace e.Models
{
    ...
    public class TechCardStep
    {
        ...
        [MaxLength(50)]
        public string? StepType { get; set; } // mixing, extrusion, cooling, packaging
    ...
    public class ProductionOrder
    {
        ...
        [MaxLength(20)]
        public string Status { get; set; } = "planned"; // planned, approved, in_progress, completed, cancelled
    ...
    public class Batch
    {
        ...
        [MaxLength(20)]
        public string Status { get; set; } = "planned"; // planned, running, completed, blocked, cancelled
    ...
    public class BatchRawMaterialUsage
    {
        ...
        public virtual RawMaterial? RawMaterial { get; set; }
        [Required, MaxLength(50)]
        public string RawBatchNumber { get; set; } = string.Empty;
        [Required]
    ...
    public class QualityControl
    {
        ...
        public virtual Batch? Batch { get; set; }
        [Required, MaxLength(20)]
        public string SampleType { get; set; } = string.Empty; // raw_material, intermediate, finished_good
        [Required, MaxLength(100)]
        public string ParameterName { get; set; } = string.Empty;
        ...
        [MaxLength(20)]
        public string? Decision { get; set; } // pending, approved, blocked
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<BatchRawMaterialUsage> BatchRawMaterialUsages { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RecipeComponent>()
                .Property(rc => rc.QuantityPercent)
                .HasPrecision(18, 4);
            ...
            modelBuilder.Entity<StepParameter>()
                .Property(sp => sp.PlannedValue)
                .HasPrecision(18, 4);

            modelBuilder.Entity<StepParameter>()
                .Property(sp => sp.ToleranceMin)
                .HasPrecision(18, 4);

            modelBuilder.Entity<StepParameter>()
                .Property(sp => sp.ToleranceMax)
                .HasPrecision(18, 4);

            modelBuilder.Entity<StepActualParameter>()
                .Property(sap => sap.ActualValue)
                .HasPrecision(18, 4);

            modelBuilder.Entity<BatchRawMaterialUsage>()
