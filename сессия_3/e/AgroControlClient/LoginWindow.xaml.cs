...
namespace AgroControlClient
{
    public partial class LoginWindow : Window
    {
        ...
        private void BtnRefresh_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                lblStatus.Text = $"Лимит замены картинки ({MaxRefreshAttempts} раза) исчерпан. Перезапустите приложение.";
            ...
            if (_timer.IsEnabled)
            {
                lblStatus.Text = $"Подождите {_remainingSeconds} секунд перед следующей заменой!";
                return;
            }
